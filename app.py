...
@st.cache_resource(hash_funcs={Oriana: lambda _: None}, ttl=60)  # Cache for 60 seconds
...
if logo_path:
    ...
    st.markdown("""
        ...
        """, unsafe_allow_html=True)
    st.warning("Logo file not found. Please add a logo.png file to your images or assets folder.")
...
if st.sidebar.checkbox("Show Debug Info"):
    st.sidebar.write("Current sources:", oriana.get_sources())
