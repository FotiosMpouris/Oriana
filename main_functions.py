...
#                 return self.get_rss_articles(subject, source)
#             else:
#                 return self.get_webpage_articles(subject, source)
#         except Exception as e:
#             print(f"Error processing {source}: {str(e)}")
#             return []

#     def get_rss_articles(self, subject, rss_url):
#         try:
...
#                 if subject.lower() in article['title'].lower() or subject.lower() in article.get('description', '').lower():
#                     full_article = self.extract_article(article['link'])
